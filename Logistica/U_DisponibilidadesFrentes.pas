   ...
   begin
      ...
      begin
        ...
        TLabelVeiculo.Parent       := TScrolMaquinas;
         ...
         TVeiculoImagePista.informacaoBalao.Observacoes.Add('EQUIPAMENTO EM OPERAÇÃO');
      ...
      begin
        ...
        TVeiculoImagePista.informacaoBalao.Observacoes.Add('Motivo da Parada :'+QR_ParadoCCOD_MOTIVO.AsString+'-'+QR_ParadoCMOTIVO.AsString
                                                      ...
                                                      +#13+'Observação :'+QR_ParadoCOBSERVACAO.AsString
                                                      +#13+'Ordem Serviço :'+QR_ParadoCORDEMSERVICO.AsString);
      ...
      begin
        ...
        TVeiculoImagePista.informacaoBalao.Observacoes.Add('Motivo da Parada :'+QR_ParadoOCOD_MOTIVO.AsString+'-'+QR_ParadoOMOTIVO.AsString
                                                      ...
                                                      +#13+'Observação :'+QR_ParadoOOBSERVACAO.AsString
                                                      +#13+'Ordem Serviço :'+QR_ParadoOORDEMSERVICO.AsString);
...
//           TVeiculoImagePista.Left  := Width_Pista_Volta - round((QR_VeiculosPORC_VOLTA.AsInteger * Width_Pista_Volta)/100);
      ...
      begin
        ...
        TVeiculoImagePista.informacaoBalao.Alarmes         := TStringList.Create;
        TVeiculoImagePista.informacaoBalao.Observacoes     := TStringList.Create;
        TVeiculoImagePista.informacaoBalao.Observacoes.Add('Veículo Fixo.'
   ...
   //Craindo os veiculos que estão descarregando na usina
   ...
   begin
     ...
     TVeiculoImagePista.informacaoBalao.Alarmes         := TStringList.Create;
     TVeiculoImagePista.informacaoBalao.Observacoes     := TStringList.Create;
     TVeiculoImagePista.informacaoBalao.Observacoes.Add('Saída da Usina    :'+ QR_DescarregandoDATA_SAIDA.AsString
                                                   +#13+'Previsão Chegada  :' + QR_DescarregandoDATA_PREV_CHEGADA.AsString
                                                   +#13+'Data Hora Chegada :' + QR_DescarregandoDATA_CHEGADA.AsString
                                                   +#13+'Veículo '+vAdiantadoAtrasado + ' em '+ FormatFloat('00', QR_DescarregandoHORAS.AsFloat)+':'+FormatFloat('00', QR_DescarregandoMINUTOS.AsFloat)+' Hrs'
                                                   );
