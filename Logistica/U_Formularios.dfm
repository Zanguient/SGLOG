inherited F_Formularios: TF_Formularios
  ...
  object QR_ProximoCodigo: TOraQuery
    Session = DM.Sessao
    SQL.Strings = (
      'SELECT NVL(max(a.cod_tela),0) + 1 cod_formulario'
      '  FROM adm.telas a'
      ' WHERE a.cod_modulo = :cod_modulo')
    Left = 232
    Top = 16
    ...
    object QR_ProximoCodigoCOD_FORMULARIO: TFloatField
      FieldName = 'COD_FORMULARIO'
    end
  end
end
